...
const steps = [
  {
    ...
    icon: Upload,
    title: 'Upload Image',
    description: 'Securely upload your image using our encrypted interface. Images are processed locally first.',
    color: 'text-cyan-400',
  ...
  },
  {
    ...
    icon: Brain,
    title: 'AI Analysis',
    description: 'Our EfficientNet-ViT model analyzes the image for deepfake indicators with high accuracy.',
