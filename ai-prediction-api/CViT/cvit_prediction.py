...
def gen_parser():
    ...
    parser.add_argument("--w", help="weight for cvit or for cvit2.")
    parser.add_argument("--n", type=str, help="network cvit or cvit2")
    parser.add_argument("--fp16", type=str, help="half precision support (y/n)")
    ...
    # 🛠 FIXED LINE:
    fp16 = args.fp16.lower() in ['y', 'yes'] if args.fp16 else False
